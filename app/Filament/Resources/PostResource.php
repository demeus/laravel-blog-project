...
class PostResource extends Resource
{
        ...
        return [
            Forms\Components\Section::make('Content')
                ->schema([
                    ...
                    MarkdownEditor::make('teaser')
                        ->maxLength(65535)
                        ->columnSpanFull()
                        ->helperText(
                            'An overview of the article used in the feed with the intent to entice readers to click through.'
                        ),
    ...
    public static function getTableColumns() : array
    {
        return [
            ...
            CheckboxColumn::make('commercial'),
            ToggleColumn::make('commercial')
